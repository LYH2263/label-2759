<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.username" placeholder="用户名" class="filter-item search-input" @keyup.enter="handleFilter" />
    ...
    >
      ...
      <el-table-column label="借阅人" prop="username" align="center" min-width="100" />
...
import { getAllBorrowRecords, returnBook, type BorrowRecord } from '@/api/borrow'
...
const getList = async () => {
  ...
  try {
    const response = await getAllBorrowRecords(listQuery)
